...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_2.clicked.connect(lambda: webbrowser.open('https://github.com/Lee-Ji-won104/EasyLabeling'))
    ...
    def clickImageFolder(self):
        ...
        if(isImageSelected==True&isModelSelected==True):
...
def makeAnnotation(imageName, results, original_image_np ):
    ...
    SubElement(root, 'folder').text = 'Easy_Labeling'
...
if __name__ == "__main__":
    ...
    MainWindow.setWindowIcon(QIcon('pngegg.png'))
    ui = Ui_MainWindow()
